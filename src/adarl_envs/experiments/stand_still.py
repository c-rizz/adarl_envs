...
def runFunction(seed, folderName, resumeModelFile, run_id, args):
    ...
    env_builder_args = {
        ...
        "obs_noise_joints_pve_ep_mustd_step_std" :  (0.0, 0.005, 0.02),
        "obs_noise_linacc_ep_mustd_step_std" :      (0.0, 0.005, 0.02),
        "obs_noise_linvel_ep_mustd_step_std" :      (0.0, 0.005, 0.02),
        "obs_noise_posz_ep_mustd_step_std" :        (0.0, 0.02, 0.02),
        "observe_full_robot_state" : False,
        "posref_safety_period" : 0.005,
        "quiet" : False,
        "randomized_dof_armature_ratios" : 0.3,
        "randomized_com_links_minmax_xyz" : [((-0.2,-0.05,-0.05),(0.2,0.05,0.05))],
        "randomized_friction_slide_spin_roll_ratios" : (0.5,0.5,0.5),
        "randomized_dof_frictionloss_ratios" : 0.3,
        ...
        "reward_joint_torqueref_weight" :         1.0,
