...
def runFunction(seed, folderName, resumeModelFile, run_id, args):
    ...
    env_builder_args = {
        ...
        "randomized_initial_joint_pose_range" : 0.001,
        ...
        "quiet" : False,
        "randomized_dof_armature_ratios" : 0.,
        "randomized_com_xyz_diff_distribution" : ("normal",([0.,0.,0.],[0.,0.,0.])),
        "randomized_friction_slide_spin_roll_ratios" : (0.,0.,0.),
        "randomized_dof_frictionloss_ratios" : 0.,
        "randomized_gains_damping_ratio_epstd" : 0.,
        "randomized_gains_stiffness_ratio_epstd" : 0.,
        "randomized_mass_ratios" : ("normal", (0.0, 0.1)),
        "record_video" : True,
        "randomization_recycle_init_pose" : True,
        "reward_joint_acceleration_weight" :      0.0,
        "reward_joint_actacc_weight" :            0.,
        "reward_joint_actdiff_weight" :           0.,
    ...
    if algo.lower() == "sac":
        ...
        ppo_train(  seed=seed,
                ...
                vec_env_builder=named_loco_venv_builder,
                env_builder_args=env_builder_args,
                agent_hyperparams=PPO_init_hyperparams(  minibatch_size=8192,
                                                    th_device=th.device("cuda"),
                                                    actor_network_arch=(512,128),
