...
def runFunction(seed, folderName, resumeModelFile, run_id, args):
    ...
    env_builder_args = {
        ...
        "mode" : mode,
        "obs_noise_angvel_ep_mustd_step_std" :      (0.0, 0.01, 0.02),
        "obs_noise_gravity_ep_mustd_step_std" :     (0.0, 0.01, 0.02),
        "obs_noise_joints_pve_ep_mustd_step_std" :  (0.0, 0.0, 0.02),
        "obs_noise_linacc_ep_mustd_step_std" :      (0.0, 0.01, 0.02),
        "obs_noise_linvel_ep_mustd_step_std" :      (0.0, 0.01, 0.02),
        "obs_noise_posz_ep_mustd_step_std" :        (0.0, 0.01, 0.02),
        "observe_full_robot_state" : False,
        "posref_safety_period" : 0.005,
        "quiet" : False,
        "randomized_armature_ratios" : 0.,
        "randomized_com_xyz_diff_distribution" : ("normal",([0.,0.,0.],[0.15,0.05,0.05])),
        "randomized_friction_slide_spin_roll_ratios" : (0.2,0.2,0.2),
        "randomized_frictionloss_ratios" : 0.2,
