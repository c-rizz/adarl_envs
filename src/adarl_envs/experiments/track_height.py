...
def runFunction(seed, folderName, resumeModelFile, run_id, args):
    ...
    eval_freq = 20
    env_builder_args = {
        "action_delay_mustd" : (0.001, 0.002),
        ...
        "quiet" : False,
        "randomized_armature_ratios" : 0.2,
        ...
        "reward_actacc_weight" :            1000.0,
        "reward_actdiff_weight" :           10.0,
