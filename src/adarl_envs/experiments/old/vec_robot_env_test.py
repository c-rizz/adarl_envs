...
def robot_env_builder(  seed,
    ...
    lrenv = RobotVecEnv(init_args.noise_action_delay_mustd_std = env_builder_args.pop("action_delay_mustd"),
                        ...
                        init_args.controlled_joints=controlled_joints,
                        init_args.goal_err_smoothing_halflife_sec = env_builder_args.pop("goal_err_smoothing_halflife_sec"),
                        init_args.maxStepsPerEpisode=max_steps,
                        init_args.minmax_damping=(1.0,30.0),
                        init_args.minmax_stiffness=(50.0,1000.0),
                        init_args.robot_main_body_link=robot_main_body_link,
                        init_args.robot_name=robot_name,
                        init_args.robot_root_link=robot_root_link,
                        init_args.robot_description_string=urdf_string,
                        init_args.safe_damping=env_builder_args.pop("safe_damping"),
                        init_args.safe_stiffness=env_builder_args.pop("safe_stiffness"),
                        init_args.safety_limits_ratios_minmax_pve=0.9,
                        init_args.seed=seed,
                        init_args.stepLength_sec=stepLength_sec,
                        init_args.step_precision_tolerance=0 if isinstance(env_controller, BaseSimulationAdapter) else 0.001,
                        init_args.stop_on_failure=env_builder_args.pop("stop_on_safety"),
                        init_args.th_device=th_device,
                        init_args.homing_joint_pose=homing_joint_pose,
                        init_args.frame_stack_length=env_builder_args.pop("frame_stack_length"),
                        observe_body_velocity=True,
                        init_args.homing_body_pose_xyz_xyzw=homing_body_pose_xyz_xyzw,
                        ...
                        init_args.randomized_initial_joint_pose_range = env_builder_args.pop("initial_pose_randomization_range"),
...
def adarl_envs_builder(seed : int,
                    ...
                    env_builder_args : dict) -> gym.vector.VectorEnv:
    import adarl.utils.utils
    model_file = adarl.utils.utils.pkgutil_get_path("adarl_envs","models/leg_rig_simple.urdf.xacro")
    homing_joint_pose={ ("leg","rail_joint") : 1.0,
                        ("leg","hip_joint_1") : 1.0,
