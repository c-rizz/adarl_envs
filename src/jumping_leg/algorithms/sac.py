...
class SAC(nn.Module):
    def __init__(self,
        ...
        self._q_net1 = build_mlp_net(arch=q_network_arch,
...
def main():
    ...
    # env setup
    num_envs = 16
    envs = AsyncVectorEnvShmem([make_env(args.env_id, args.seed, i, args.capture_video, run_name) for i in range(num_envs)],
                                     context="forkserver")
