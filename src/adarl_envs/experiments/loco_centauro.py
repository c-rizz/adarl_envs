...
def runFunction(seed, folderName, resumeModelFile, run_id, args):
    ...
    env_builder_args = {
        ...
        "randomized_com_xyz_diff_distribution" : ("normal",([0.,0.,0.],[0.10*r,0.04*r,0.05*r])),
        "randomized_friction_slide_spin_roll_ratios" : [0.2*r,0.2*r,0.2*r],
        "randomized_dof_frictionloss_ratios"             : 0.2*r,
        ...
        "reward_joint_acceleration_weight" :        5.0,
        "reward_joint_actacc_weight" :              eps,
        "reward_joint_actdiff_weight" :             eps,
        ...
        "reward_joint_posref_acc_weight":           1.0,
        "reward_joint_sensed_effort_weight" :       eps,
        "reward_slip_weight" :                eps,
        "reward_joint_stand_position_weight" :      1.0,
