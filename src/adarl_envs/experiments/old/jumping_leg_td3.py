...
from adarl_envs.experiments.build_adarl_envs_env import build_env
...
def runFunction(seed, folderName, resumeModelFile, run_id, args):
    ...
    max_steps = int(lrenv.get_max_episode_steps().item())
    ...
    model = TD3(MultiInputPolicy, env, action_noise=action_noise, verbose=1, batch_size=128,
    ...
    model.learn(total_timesteps=1000000,
                callback=WandbCallback( model_save_path=f"{folderName}/wandb/save",
                                        verbose=2,
                                    ))
