...
def loco_runner_builder(seed,
    ...
    lrenv = LocomotionVecEnv(action_delay_mustd = env_builder_args.pop("action_delay_mustd"),
                            ...
                            reward_underground_weight = env_builder_args.pop("reward_underground_weight"),
...
def get_quad_args():
    ...
    return {"model_file" : adarl.utils.utils.pkgutil_get_path("jumping_leg","models/quad_simple.urdf.xacro"),
            ...
            "safe_limits_position_offset" : {k:0 for k in homing},
...
def get_kyon_args():
    return {"model_file" : adarl.utils.utils.pkgutil_get_path("iit-kyon-ros-pkg","kyon_urdf/urdf/kyon.urdf.xacro"),
            ...
            "homing_body_pose_xyz_xyzw" : (0.,0.,0.415,0.,0.,0.,1.),
...
def get_centauro_args():
    return {"model_file" : adarl.utils.utils.pkgutil_get_path("iit-centauro-ros-pkg","centauro_urdf/urdf/centauro.urdf.xacro"),
            ...
            "robot_main_body_link" : "pelvis",
            "robot_root_link" : "pelvis",
            "homing_body_pose_xyz_xyzw" : (0.,0.,0.79,0.,0.,0.,1.),
            "disallowed_contact_links" : [ ],
            "terminating_contact_pairs" : [ ],
            "controlled_joints" : [JOINT_FILTERS.ALL_REVOLUTE],
            "mass_randomized_links" : [LINK_FILTERS.ALL_ROBOT],
